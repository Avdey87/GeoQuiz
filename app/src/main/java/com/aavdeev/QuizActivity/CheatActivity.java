package com.aavdeev.QuizActivity;
...
public class CheatActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ANSWER_IS_TRUE ="com.aavdeev.QuizActivity.answer_is_true";
    ...
    public void setAnswerShownResult(boolean answerShownResult) {
        this.answerShownResult = answerShownResult;
    }

    public static boolean wasAnswerButton(Intent data) {
        return false;
    }
}
